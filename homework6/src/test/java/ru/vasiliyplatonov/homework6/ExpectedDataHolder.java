...
public class ExpectedDataHolder {
	...
	public static final Set<Genre> EXPECTED_GENRES = Set.of(EXPECTED_GENRE_1, EXPECTED_GENRE_2, EXPECTED_GENRE_3, EXPECTED_GENRE_4);
	public static final Set<Author> EXPECTED_AUTHORS = Set.of(EXPECTED_AUTHOR_1, EXPECTED_AUTHOR_2);
	public static final Set<Book> EXPECTED_BOOKS = Set.of(EXPECTED_BOOK_1, EXPECTED_BOOK_2, EXPECTED_BOOK_3, EXPECTED_BOOK_4);

	static {
		EXPECTED_AUTHOR_1.setBooks(Set.of(EXPECTED_BOOK_1, EXPECTED_BOOK_2));
		EXPECTED_AUTHOR_2.setBooks(Set.of(EXPECTED_BOOK_3, EXPECTED_BOOK_4));

		EXPECTED_BOOK_1.setBookComments(Set.of(EXPECTED_BOOK_COMMENT_1, EXPECTED_BOOK_COMMENT_2, EXPECTED_BOOK_COMMENT_3));
		EXPECTED_BOOK_2.setBookComments(Set.of(EXPECTED_BOOK_COMMENT_4, EXPECTED_BOOK_COMMENT_5));
		EXPECTED_BOOK_3.setBookComments(Set.of(EXPECTED_BOOK_COMMENT_6));
